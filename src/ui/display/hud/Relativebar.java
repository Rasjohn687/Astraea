...
public class Relativebar extends HudElement
{
	...
	public void update()
	{
		...
		{			
			leftValue = Game.getPlayerOne().getFleetValueUnit() + Game.getPlayerOne().getMinerals();
			rightValue = Game.getPlayerTwo().getFleetValueUnit() + Game.getPlayerTwo().getMinerals();
		}
	}
