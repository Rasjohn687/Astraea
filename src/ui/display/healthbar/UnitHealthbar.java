...
public class UnitHealthbar extends Healthbar
{
	...
	{
        return Settings.showCapacitybars && !owner.isDead() && owner.getCapacity() != 0;
	}
	...
	public boolean showingHealthbar()
	{
		...
		else return !Settings.smartUnitHealthbars || !owner.isUndamaged();
	}	
	...
	public boolean showingUsebar()
	{
		...
		else return !Settings.smartUsebars;
	}
