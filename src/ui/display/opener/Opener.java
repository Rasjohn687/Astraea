...
//		
		...
		Utility.drawStringCenterCenter(g,  Fonts.massiveFont, "VS", Main.getScreenWidth() * .5f+2, Main.getScreenHeight() * .40f+2);
		g.setColor(new Color(255, 255, 255, Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.massiveFont, "VS", Main.getScreenWidth() * .5f, Main.getScreenHeight() * .40f);
		
		
		g.setColor(new Color(40, 40, 40, Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.mediumFont, "Map", Main.getScreenWidth() * .5f+2, Main.getScreenHeight() * .51f+2);
		g.setColor(new Color(200, 200, 120,  Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.mediumFont, "Map", Main.getScreenWidth() * .5f, Main.getScreenHeight() * .51f);
		
		g.setColor(new Color(40, 40, 40, Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.bigFont, TerritoryManager.getTerritory().getName(), Main.getScreenWidth() * .5f+2, Main.getScreenHeight() * .54f+2);
		g.setColor(new Color(180, 180, 180, Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.bigFont, TerritoryManager.getTerritory().getName(), Main.getScreenWidth() * .5f, Main.getScreenHeight() * .54f);


		g.setColor(new Color(40, 40, 40, Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.mediumFont, "Music", Main.getScreenWidth() * .5f+2, Main.getScreenHeight() * .61f+2);
		g.setColor(new Color(200, 200, 120,  Opener.getAlpha()));
		Utility.drawStringCenterCenter(g,  Fonts.mediumFont, "Music", Main.getScreenWidth() * .5f, Main.getScreenHeight() * .61f);

		if(AudioManager.getGameMusic() != null) {
			String musicLabel = "\"" + AudioManager.getGameMusic().getTitle() + "\"";
			g.setColor(new Color(40, 40, 40, Opener.getAlpha()));
			Utility.drawStringCenterCenter(g, Fonts.bigFont, musicLabel, Main.getScreenWidth() * .5f + 2, Main.getScreenHeight() * .64f + 2);
			g.setColor(new Color(180, 180, 180, Opener.getAlpha()));
			Utility.drawStringCenterCenter(g, Fonts.bigFont, musicLabel, Main.getScreenWidth() * .5f, Main.getScreenHeight() * .64f);

			String artistLabel = "by " + AudioManager.getGameMusic().getArtist();
			g.setColor(new Color(40, 40, 40, Opener.getAlpha()));
			Utility.drawStringCenterCenter(g, Fonts.bigFont, artistLabel, Main.getScreenWidth() * .5f + 2, Main.getScreenHeight() * .67f + 2);
			g.setColor(new Color(180, 180, 180, Opener.getAlpha()));
			Utility.drawStringCenterCenter(g, Fonts.bigFont, artistLabel, Main.getScreenWidth() * .5f, Main.getScreenHeight() * .67f);
		}
